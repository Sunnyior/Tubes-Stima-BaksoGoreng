...
Greedy Algorithm that we use in this bot is Greedy by density (point/distance)
...
1. To run one bot
    ...
    ```
    python main.py --logic baksoo --email=your_email@example.com --name=your_name --password=your_password --team etimo
    ```
